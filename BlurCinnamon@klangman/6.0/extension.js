...
class BlurFocusEffect extends BlurBase {
   ...
   _addEffect(window) {
      ...
      this._setClip();
      //if (this._focusedCompositor.get_transition("x") || this._focusedCompositor.get_transition("y") ) {
      //   this._signalManager.connect(this._focusedCompositor, "transition-stopped", () => {
      //      this._background.show();
      //      this._signalManager.disconnect("transition-stopped", this._focusedCompositor);
      //   });
      //} else {
         this._background.show();
      //}
